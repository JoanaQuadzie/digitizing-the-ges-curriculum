  ...
  return (
    <div className="p-4">
      ...
      >
        ...
        <div className="flex flex-col md:justify-center md:flex-row md:mt-14 md:gap-24">
          <img className="md:w-96" src={Vector} />
          <div className="md:w-[950px]">
            <h2 className="font-bold text-3xl font-serif my-4 w-1/2">
              Enjoy Learning with a Unique Curriculum Experience
            </h2>
            <p className="text-xl font-serif w-1/2  text-gray-500">
